...
export const CallIcon = ({ className, ...rest }) => (
  <svg
    ...
    style={{
      enableBackground: "new 0 0 122.88 118.72",
    }}
    xmlSpace="preserve"
    {...rest}
  >
